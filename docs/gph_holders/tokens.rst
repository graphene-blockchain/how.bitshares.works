...
These SmartCoins track the value of an underlaying asset, such as Gold, or U.S. Dollar. Smartcoins can be created by anyone contracting with the Graphene ecosystem and putting sufficient GPH (at least 175%) into the so called contract for difference as collateral.
...
An FBA is a token that pays you a fraction of the transaction fees generated by a particular feature that has been funded independent of Graphene.
